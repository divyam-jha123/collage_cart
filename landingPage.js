// CampusHub - Standalone JavaScript
...
document.querySelectorAll('.feature-card, .category-card, .step-card, .events-content').forEach(el => {
    el.style.opacity = '0';
...
// Log page load
console.log('College Cart loaded successfully! 🎓');
...
function showNotification(message, type = 'success') {
    ...
    notification.style.cssText = `
        ...
        right: 20px;
        padding: 1rem 1.5rem;
        background: ${type === 'success' ? 'hsl(214, 100%, 58%)' : 'hsl(0, 84%, 60%)'};
        color: white;
